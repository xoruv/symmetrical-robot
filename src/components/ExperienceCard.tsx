...
export default function ExperienceCard({ url, title, fullDescription, cardDescription, cardImage, media, delay, gradient, myRole, timeline, CarouselComponent = MediaCarousel }: { 
    url?: string, 
    title: string, 
    ...
    myRole: string, 
    timeline: string,
    CarouselComponent?: React.ComponentType<{ media: string[] }> 
}) {
